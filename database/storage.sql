...
(
    `id`     INTEGER PRIMARY KEY AUTO_INCREMENT COMMENT 'internal identifier of the root object',
...
(
    ...
    `id`               INTEGER PRIMARY KEY AUTO_INCREMENT COMMENT 'internal identifier',
    ...
    `root`             INTEGER NOT NULL COMMENT 'the OCFL storage root id that the object is stored in'
